                                ...
                                <div style="font-family: sans-serif">
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                          ...
                                          text-align: center;
                                        ">
                                      <span style="font-size: 28px"><strong><span style="font-size: 28px">Bạn đã đóng tiền tham gia lớp học thành công </span></strong></span>
                                    </p>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            color: #000000;
                                            font-size: 16px;
                                          "><strong>Tên lớp học : {{$class->name}}</strong>
                                      </span>
                                    </p>
                                    <p style="
                                          margin: 0;
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Giá tiền : {{ number_format($class->course->price) }} VNĐ
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Ngày khai giảng : {{ date("d-m-Y", strtotime($class->start_date)) }}
                                    </p>
                                  </div>
                                </div>
                              </td>
                                ...
                                <div style="font-family: sans-serif">
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Tên khách hàng : {{$hoc_vien->ho_ten}}
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Số điện thoại : {{$hoc_vien->so_dien_thoai}}
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Số tiền đã đóng : {{ number_format($paymentAdd->price)}} VNĐ
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Ngày thanh toán : {{ date("d-m-Y H:i:s", strtotime($paymentAdd->payment_date)) }}
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Mã giao dịch : {{$paymentAdd->id_giao_dich}}
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Mã đơn hàng : {{$paymentAdd->id_don_hang}}
                                    </p>
                                  </div>
                                </div>
                              </td>
