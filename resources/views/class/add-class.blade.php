...
@section('content')
    ...
    <section class="content appTuyenSinh">
        ...
        ?>
        @if (Session::has('erroraddnew'))
            <div class="alert alert-danger alert-dismissible" role="alert">
                <strong>
                    @foreach (Session::get('erroraddnew') as $error)
                        <li>{{ $error }}</li>
                    @endforeach
                </strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        {{-- </div> --}}
                        <div class="form-group">
                            <label for="name" class="col-md-3 col-sm-4 control-label">Tên lớp học <span
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="slot" id="ten_khoa_hoc" class="form-control"
                                    value="@isset($request['slot']) {{ $request['slot'] }} @endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="start_date" id="ten_khoa_hoc" class="form-control"
                                    value="@isset($request['name']) {{ $request['name'] }} @endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="end_date" id="ten_khoa_hoc" class="form-control"
                                    value="@isset($request['name']) {{ $request['name'] }} @endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-8">
                    <select name="id_ca" id="id_danh_muc" class="form-control select2"
                        ...
                        @foreach ($Ca as $item)
                            <option value="{{ $item->id }}"
                                @isset($request['id_ca']) @if ($request['id_ca'] == $item->id) selected @endif
                            @endisset>{{ $item->ca_hoc }}</option>
                    @endforeach
                </select>
            </div>
        </div>
