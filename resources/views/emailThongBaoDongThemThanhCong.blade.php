...
<body>
    ...
    <p>Thông báo bạn vừa đóng thêm số tiền : {{ number_format($paymentUpdate->price) }} VNĐ  , bạn đã được xếp vào danh sách sinh viên lớp : {{ $class->name}} vui lòng kiểm tra lịch học trong profile của mình</p>
    </table>
</body>
