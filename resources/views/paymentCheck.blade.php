                                ...
                                <div style="font-family: sans-serif">
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                          ...
                                          text-align: center;
                                        ">
                                      <span style="font-size: 28px"><strong><span style="font-size: 28px">Bạn đã đang kí tham gia lớp học </span></strong></span>
                                    </p>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            color: #000000;
                                            font-size: 16px;
                                          "><strong>Tên lớp học : {{$emails->name}}</strong>
                                      </span>
                                    </p>
                                    <p style="
                                          margin: 0;
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Giá tiền : {{ number_format($emails->price) }} VNĐ
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Ngày khai giảng : {{ date("d-m-Y", strtotime($emails->start_date)) }}
                                    </p>
...
<p style="
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                     Giới tính : @if ($emails->gioi_tinh==1)
                                         Nam
                                     @elseif($emails->gioi_tinh==1)
                                         Nữ
                                         @else Khác
                                     @endif
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Số tiền đã đóng : {{number_format($emails->gia_tien)}} VNĐ
                                    </p>
