<body>
    ...
    <a href="http://localhost:3000/vi/re-payment?lop-cu={{$classOld->name}}&lop-moi={{$classNews->name}}&amount={{abs($dangKyOld->du_no)}}&id={{$dangKyOld->id}}">đóng trực tiếp tại đây </a>
</body>