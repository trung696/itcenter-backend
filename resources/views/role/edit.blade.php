    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                    ...
                    @endif
                <form action="{{route('route_BackEnd_role_update',['id'=>$roleEdit->id])}}" method="post" style="width:100%">
                    @csrf

                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Thêm vai trò</label>
                            <input type="text" name="name" value="{{$roleEdit->name}}" class="form-control" placeholder="Nhập vai trò">
                        </div>
                        <div class="form-group">
                            <label>Mô tả vai trò</label>
                            <input type="text" name="description" value="{{$roleEdit->description}}" class="form-control" placeholder="Nhập mô tả vai trò">
                        </div>
                    </div>
                                    ...
                                    @foreach ($moduleParent->permissionChildrent as $moduleChildren)
                                        <div class="card-body col-md-3">
                                            <h5 class="card-title ">
                                                ...
                                                {{$permissionChecked->contains('id',$moduleChildren->id) ? 'checked' : ''}}
