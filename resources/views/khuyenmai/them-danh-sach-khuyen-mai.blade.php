                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="ma_khuyen_mai" class="col-md-3 col-sm-4 control-label">Mã Khuyến Mại <span
                        ...
                        <div class="form-group">
                            <label for="ten_khuyen_mai" class="col-md-3 col-sm-4 control-label">Tên khuyến mại <span
                                    class="text-danger">(*)</span></label>

                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_khuyen_mai" id="ten_khuyen_mai" class="form-control"
                                    value="@isset($request['ten_khuyen_mai']) {{ $request['ten_khuyen_mai'] }} @endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="phan_tram_khuyen_mai" class="col-md-3 col-sm-4 control-label">Phần trăm khuyến
                                mại<span class="text-danger">(*)</span></label>

                            <div class="col-md-9 col-sm-8">
                                <input type="number" name="phan_tram_khuyen_mai" id="phan_tram_khuyen_mai"
                                    class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <img id="hinh_anh_khuyen_mai_preview" src="http://placehold.it/100x100"
                                        ...
                                        <input type="file" name="hinh_anh_khuyen_mai" accept="image/*"
                                            class="form-control-file @error('hinh_anh_khuyen_mai') is-invalid @enderror"
                                            id="hinh_anh_khuyen_mai">
                                    </div>
                                </div>
                            </div>
                        </div>
