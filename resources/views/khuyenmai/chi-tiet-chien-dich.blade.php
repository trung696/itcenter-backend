                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_chien_dich" id="ten_chien_dich" class="form-control"
                                       value="@isset($request['ten_chien_dich'])  {{ $request['ten_chien_dich'] }} @else {{ $objItem->ten_chien_dich }} @endisset" @if($objItem->ten_chien_dich != '')  @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="phan_tram_giam" id="phan_tram_giam" class="form-control"
                                       value="@isset($request['phan_tram_giam'])  {{ $request['phan_tram_giam'] }} @else {{ $objItem->phan_tram_giam }} @endisset" @if($objItem->phan_tram_giam != '')  @endif>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ngay_bat_dau" id="ngay_bat_dau" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ngay_ket_thuc" id="ngay_ket_thuc" class="form-control"
            ...
            <div class="box-body">
                    ...
                    <form action="" method="get">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    <input type="text" name="search_ma" class="form-control" placeholder="Nhập mã cần tìm"
                        ...
                        <div class="col-xs-12" style="text-align:center;">
                            <div class="form-group">
                                ...
                                <a href="{{ route('route_BackEnd_ChienDich_Detail',['id'=>request()->route('id')]) }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                    Clear </a>
                            </div>
                        </div>
                    </form>
                                ...
                                <form action="" method="post" id="preview_form">
                                    ...
                                    <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="so_luong" id="so_luong" value="@isset($request['so_luong']){{ $request['so_luong'] }}@endisset">
                                                <input type="hidden" class="form-control" name="id_chien_dich" id="id_chien_dich" value="{{ $objItem->id }}">
                                            </div>
                                    </div>

                                    <div class="text-center">
                                        <button class="btn btn-primary" id="saveMaChienDich" type="submit">Lưu lại</button>
                ...
                <div v-if="list_hoa_dons.length>0" class="table-responsive">
                    <table class="table table-bordered" style="margin-top:20px;">
                        ...
                        @php($i = 1)
                        @foreach($objItemMaChienDich as $key => $item)
                            <tr>
