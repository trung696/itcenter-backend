                                ...
                                <div style="font-family: sans-serif">
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                          ...
                                          text-align: center;
                                        ">
                                      <span style="font-size: 28px"><strong><span style="font-size: 28px">Đã hoàn chả số tiền thừa đến bạn  </span></strong></span>
                                    </p>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            color: #000000;
                                            font-size: 16px;
                                          "><strong>Họ và tên : {{$hoc_vien->ho_ten}} </strong>
                                      </span>
                                    </p>
                                    <p style="
                                          margin: 0;
                                          ...
                                          margin-left: 10px;
                                        ">
                                     Ngày sinh :  {{ date("d-m-Y", strtotime($hoc_vien->ngay_sinh)) }}
                                    </p>
                                    <p style="
                                          margin: 0;
                                          font-size: 14px;
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            ...
                                            font-size: 16px;
                                          ">
                                        <strong>Thông tin số tiền hoàn</strong>
                                      </span>
                                    </p>
                                    <p style="
                                          margin: 0;
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Số tiền : {{ number_format($so_tien_thua) }} VNĐ
                                    </p>
                                    <p style="
                                          margin: 0;
                                          font-size: 14px;
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Hình thức : Kí xác nhận và nhận tiền trực tiếp tại trung tâm
                                    </p>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            ...
                                            font-size: 16px;
                                          ">
                                        <strong>Cảm ơn bạn đã tin tưởng trung tâm. Mọi thắc mắc xin liên hệ để được giải quyết sớm nhất</strong>
                                      </span>
                                    </p>
                                  </div>
                                </div>
