                                ...
                                <div style="font-family: sans-serif">
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                          ...
                                          text-align: center;
                                        ">
                                      ĐÂY LÀ THÔNG TIN HOÀN TIỀN CHO BẠN
                                    </p>
                                  </div>
                                </div>
                              </td>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            ...
                                            font-size: 16px;
                                          ">
                                        <strong>Thông tin về số tiền hoàn</strong>
                                      </span>
                                    </p>
                                    <p style="
                                          margin: 0;
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Số tiền đã hoàn : {{ number_format($payMentEdit->price) }} VNĐ
                                    </p>
                                    ...
                                    <p style="
                                          ...
                                          margin-left: 10px;
                                        ">
                                      Hình thức : nhận và kí biên bản tại trung tâm
                                    </p>
                                  ...
                                  <div class="txtTinyMce-wrapper" style="
                                    ...
                                    <p style="
                                      ...
                                      <span style="
                                            ...
                                            font-size: 16px;
                                          ">
                                        <strong>Cảm ơn bạn đã tin tưởng và đồng hành cùng trung tâm  </strong>
                                      </span>
                                    </p>
                                  </div>
                                </div>
