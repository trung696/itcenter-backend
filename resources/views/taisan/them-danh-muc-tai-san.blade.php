                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="ten_danh_muc" class="col-md-3 col-sm-4 control-label">Tên danh mục <span class="text-danger">(*)</span></label>

                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_danh_muc" id="ten_danh_muc" class="form-control" value="@isset($request['ten_danh_muc']){{ $request['ten_danh_muc'] }}@endisset">
