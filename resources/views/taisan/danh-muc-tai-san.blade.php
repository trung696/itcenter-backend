                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            <input type="text" name="search_ten_danh_muc_tai_san" class="form-control" placeholder="Tên danh mục tài sản"
                                   value="@isset($extParams['search_ten_danh_muc_tai_san']){{$extParams['search_ten_danh_muc_tai_san']}}@endisset">
                        </div>
                    </div>
                    {{--                    @endif--}}
                    <div class="clearfix"></div>
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/taisan-category') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('route_BackEnd_DanhMucTaiSan_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as  $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ route('route_BackEnd_DanhMucTaiSan_Detail',['id'=> $item->id]) }}" title="Sửa"><i class="fa fa-edit"></i></a></td>
                            </tr>
                        @endforeach
