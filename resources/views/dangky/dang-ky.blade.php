            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        <input type="text" name="search_ten_hoc_vien" class="form-control" placeholder="Tên học viên" value="@isset($extParams['search_ten_hoc_vien']) {{ $extParams['search_ten_hoc_vien'] }} @endisset">
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        <input type="date" name="search_ngay_dang_ky" class="form-control  " placeholder="Chọn ngày đăng ký" value="@isset($extParams['search_ngay_dang_ky']) {{ $extParams['search_ngay_dang_ky'] }} @endisset" autocomplete="off">
                ...
                <div class="col-xs-12" style="text-align:center;">
                    <div class="form-group">
                        ...
                        <a href="{{ url('/danh-sach-dia-diem') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                            Clear </a>
                        <a href="{{ route('route_BackEnd_DangKyAdmin_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                            Add new</a>
                    </div>
                </div>
            </div>
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="{{ route('route_BackEnd_AdminDangKy_Detail', ['id' => $item->id]) }}" title="Sửa"><i class="fa fa-edit"></i></a></td>
                        </tr>
                        @endforeach
