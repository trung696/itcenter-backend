        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ho_ten" class="col-md-3 col-sm-4 control-label">Họ tên học viên <span class="text-danger">(*)</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            ...
                            ?>
                            <input type="date" name="ngay_sinh" id="ngay_sinh" class="form-control" min="{{ $mindate }}" max="{{ $maxdate }}" value="@isset($request['ngay_sinh']) {{ $request['ngay_sinh'] }} @endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-8">
                            <input type="text" name="so_dien_thoai" id="so_dien_thoai" maxlength="10" class="form-control" value="@isset($request['so_dien_thoai']) {{ $request['so_dien_thoai'] }} @endisset">
                            <span id="mes_sdt"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-md-3 col-sm-4 control-label">Gmail<span class="text-danger">(*)</span></label>
                        <div class="col-md-9 col-sm-8">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-8">
                    <div class="row">
                        <div class="col-xs-6">
                            <img id="hinh_anh_preview" src="http://placehold.it/100x100" alt="your image" style="max-width: 200px; height:100px; margin-bottom: 10px;" class="img-fluid" />
                            <input type="file" name="hinh_anh" accept="image/*" class="form-control-file @error('hinh_anh') is-invalid @enderror" id="hinh_anh">
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-8">
                    <select name="id_khoa_hoc" id="id_khoa_hoc" class="form-control select2" data-placeholder="Chọn khoá học">
                        <option value="">== Chọn khoá học==</option>
                        @foreach ($objKhoaHoc as $item)
                        <option value="{{ $item->id }}" @isset($request['id_khoa_hoc']) @if ($request['id_khoa_hoc']==$item->id) selected @endif
            ...
            <div class="form-group">
                <label for="pham_tram_giam" class="col-md-3 col-sm-4 control-label">Phần Trăm Giảm<span class="text-danger">(*)</span></label>
                <div class="col-md-9 col-sm-8">
                    <input type="text" name="pham_tram_giam" id="pham_tram_giam" class="form-control" value="@isset($request['pham_tram_giam']) {{ $request['pham_tram_giam'] }} @endisset">
                    <span id="mes_sdt"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-8">
                    <select name="id_lop_hoc" id="id_lop_hoc" class="form-control select2" data-placeholder="Chọn lớp học">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-8">
                    <select name="trang_thai" id="trang_thai" class="form-control select2" data-placeholder="Chọn trạng thái">
                        ...
                        <option value="0" @isset($request['trang_thai']) @if ($request['trang_thai']==0) selected @endif @endisset>Chưa thanh toán</option>
                        <option value="1" @isset($request['trang_thai']) @if ($request['trang_thai']==1) selected @endif @endisset>Đã thanh toán</option>
