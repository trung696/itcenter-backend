...
@section('content')
    ...
    <section class="content appTuyenSinh">
        ...
        <form class="form-horizontal "
            action="{{ route('route_BackEnd_AdminDangKy_Update', ['id' => request()->route('id'), 'email' => $itemHV->email, 'oldClass' => $itemDK]) }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ngay_sinh" id="ngay_sinh" class="form-control"
                                    value="{{ $itemHV->ngay_sinh }}" disabled>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_dien_thoai" id="so_dien_thoai" class="form-control"
                                    value="{{ $itemHV->so_dien_thoai }}" disabled>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gia_tien" class="col-md-3 col-sm-4 control-label">Giá tiền <span
                                    class="text-danger">(*)</span></label>

                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="gia_tien" id="gia_tien" class="form-control"
                                    value="{{ number_format($itemGia, 0, ',', '.') }}" disabled>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select disabled name="id_khoa_hoc_cu" id="id_khoa_hoc_cu" class="form-control select2"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select disabled name="id_lop_hoc_cu" id="id_lop_hoc_cu" class="form-control select2"
                                    style="width: 100%" data-placeholder="Chọn lớp học">
                        ...
                        @if ($getDuNo != 0 && $getDuNo < 0)
                            <div class="form-group">
                                <label for="so_dien_thoai" class="col-md-3 col-sm-4 control-label">Còn thiếu <span
                                        class="text-danger">(*)</span></label>

                                <div class="col-md-9 col-sm-8">
                                    <input type="text" name="so_dien_thoai" id="so_dien_thoai" class="form-control"
                                        value="{{ number_format($getDuNo) }}" disabled>
                                    <span id="mes_sdt"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="dong_them" class="col-md-3 col-sm-4 control-label">Đóng thêm <span
                                        class="text-danger">(*)</span></label>
                                <div class="col-md-9 col-sm-8">
