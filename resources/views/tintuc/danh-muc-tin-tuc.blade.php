                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            <input type="text" name="search_ten_danh_muc_tin_tuc" class="form-control" placeholder="Tên danh mục tin tức"
                                   value="@isset($extParams['search_ten_danh_muc_tin_tuc']){{$extParams['search_ten_danh_muc_tin_tuc']}}@endisset">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/khoahoc-category') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as  $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{ route('route_BackEnd_DanhMucKhoaHoc_Detail',['id'=> $item->id ]) }}" style="white-space:unset;text-align: justify;"> {{$item->ten_danh_muc}} <i class="fa fa-edit"></i></a></td>
