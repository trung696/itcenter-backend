                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/danh-sach-dia-diem') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('route_BackEnd_DiaDiem_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as  $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$item->ten_dia_diem}}</td>
                                ...
                                <td class="text-center"><a href="{{ route('route_BackEnd_DiaDiem_Detail',['id'=> $item->id ]) }}" title="Sửa"><i class="fa fa-edit"></i></a></td>
                            </tr>
                        @endforeach
