...
@section('content')
    ...
    <!-- Phần nội dung riêng của action  -->
        <form class="form-horizontal " action="{{ route('route_BackEnd_CentralFacility_Update',['id'=>request()->route('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                    ...
                                    <label for="name" class="col-md-3 col-sm-4 control-label">Tên địa điểm <span class="text-danger">(*)</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <textarea name="address" id="ten_dia_diem" class="form-control" value="">
                                    @isset($request['address'])  {{ $request['address'] }} @else {{ $objItem->address }} @endisset @if($objItem->address != '')  @endif
                                </textarea>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <textarea name="description" id="ten_dia_diem" class="form-control" value="">
