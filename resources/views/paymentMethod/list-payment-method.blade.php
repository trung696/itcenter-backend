                ...
                <div class="row">
                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/payment-method') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('route_BackEnd_PaymentMethod_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as  $item)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ route('route_BackEnd_PaymentMethod__Detail',['id'=> $item->id ]) }}" title="Sửa"><i class="fa fa-edit"></i></a></td>
                                <td class="text-center"><a onclick="return confirm('Bạn có muốn xóa?')" href="{{ route('route_BackEnd_PaymentMethod_Delete',['id'=> $item->id ]) }}" title="Xóa"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                            </tr>
                        @endforeach
