...
//            ->select( array_merge($this->fillable,['tb2.username as uName', 'tb2.fullname as hoten_tuvan']))
    ...
    public function saveNew($params)
    {
        ...
        $maTaiSanCon = 'TSC'.str_pad($latestID + 1, 8, "0", STR_PAD_LEFT);
//        $maTaiSanCon = 'TSC';
        unset($params['cols']['_token']);

        $data =  array_merge($params['cols'],[
            'ngay_sua_chua' => $params['cols']['ngay_sua_chua'],
            'noi_dung' => $params['cols']['noi_dung'],
            'nguyen_nhan' => $params['cols']['nguyen_nhan'],
            'chi_phi' => $params['cols']['chi_phi'],
            'nguon_chi' => $params['cols']['nguon_chi'],
            'id_tai_san_con' => $params['cols']['id_tai_san_con'],
