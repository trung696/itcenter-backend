...
class Course extends Model
{
    ...
    protected $fillable = ['tb1.id', 'tb1.price', 'tb1.name', 'tb1.description', 'tb1.status', 'tb1.image','tb1.content','tb1.result', 'tb1.category_id', 'tb1.created_at', 'tb1.updated_at'];
