...
class LopHoc extends Model
{
    ...
    protected $fillable = ['tb1.id', 'tb1.ten_lop_hoc', 'tb1.thoi_gian_khai_giang', 'tb1.id_dia_diem', 'tb1.id_khoa_hoc', 'tb1.id_giang_vien', 'tb1.so_cho', 'tb1.trang_thai', 'tb1.created_at', 'tb1.updated_at'];
