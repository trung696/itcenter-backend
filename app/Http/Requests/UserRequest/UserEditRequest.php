...
use  App\Rules\UserUpdateEmailUniqueRequest;
...
class UserEditRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => ['bail','required','email',new UserUpdateEmailUniqueRequest],
            'password' => ['bail','required','min:5','string'],
    ...
    public function messages()
    {
        return [
            ...
            'password.max' => 'Mật khẩu không dưới 5 kí tự',
            ...
            // 'phone.number' => 'Số điện thoại không đúng định dạng',
            // 'phone.max' => 'Số điện thoại quá 12 số',
        ];
    }
}
