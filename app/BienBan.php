...
class BienBan extends Model
{
    ...
    //
    //
    protected $table = 'bien_ban_ban_giao_ts';
    protected $fillable = ['tb1.id','tb1.ngay_lap','tb1.ho_ten_nguoi_giao','tb1.chuc_danh_nguoi_giao','tb1.bo_phan_nguoi_giao','tb1.ho_ten_nguoi_nhan','tb1.chuc_danh_nguoi_nhan','tb1.bo_phan_nguoi_nhan','so_luong_bien_ban','id_don_vi','tb1.created_at','tb1.updated_at'];
