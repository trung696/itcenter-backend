...
class ChienDich extends Model
{
    ...
    protected $fillable = ['tb1.id', 'tb1.ten_chien_dich', 'tb1.phan_tram_giam', 'tb1.ngay_bat_dau', 'tb1.ngay_ket_thuc', 'tb1.trang_thai', 'tb1.course_id', 'tb1.created_at', 'tb1.updated_at'];
    ...
    public function loadListWithPager($params = array())
    {
        ...
        if (isset($params['search_khoa_hoc']) && $params['search_khoa_hoc']) {
            $query->where('tb1.course_id', $params['search_khoa_hoc']);
        }
    ...
    public function saveNew($params)
    {
        ...
        $data = array_merge($params['cols'], [
            'ten_chien_dich' => $params['cols']['ten_chien_dich'],
